...
### Tehtävien palautuksen deadline 14.9 klo 23.59

## palautetaan GitHubin kautta

* tehtävät 4 ja 5 tehdään paikalliseen repositorioon, eli ne eivät näy palautuksessa mitenkään
* tee palautusta varten yksityinen repositorio ja lisää sille collaboratoriksi käyttäjät josalmi ja ljleppan, voit käyttää myös viikon 1 repositoriotasi
